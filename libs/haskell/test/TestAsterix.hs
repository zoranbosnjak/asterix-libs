...
testRuleVariationDependent = do
    let obj :: Variation (Rule (Cat_000_1_0 ~> "032" ~> "CC" ~> "CP") '[ 1, 2]) = 1
    assertUint 1 obj
...
testGroup1 = do
    ...
    let var = getVariation obj4
    assertUint 0x01 (getGroupItem @"SAC" var)
    assertUint 0x02 (getGroupItem @"SIC" var)
    assertEqual "spares" [] (getGroupSpares var)
...
testGroup2 = do
    ...
    let var = getVariation obj
    assertUint 1 (getGroupItem @"I1" var)
    assertUint 3 (getGroupItem @"I2" var)
    assertEqual "spares" [2::Integer, 4] (bitsToNum <$> getGroupSpares var)
...
testExtended1 = do
    let act = parseNonSpare (schema @(RecordOf Cat_000_1_0 ~> "053") Proxy)
        ...
        env = Env parsingStore StrictParsing bs
    ...
    assertUint 1 (fromJust $ getExtendedItem @"I1" var)
    assertUint 2 (fromJust $ getExtendedItem @"I2" var)
    assertEqual "I3" True (isNothing $ getExtendedItem @"I3" var)
    assertEqual "I4" True (isNothing $ getExtendedItem @"I4" var)
    assertEqual "I5" True (isNothing $ getExtendedItem @"I5" var)
    ...
    assertEqual "I3" True (isJust $ getExtendedItem @"I3" var6)
    assertEqual "I4" True (isJust $ getExtendedItem @"I4" var6)
    assertEqual "I5" True (isJust $ getExtendedItem @"I5" var6)
...
testExtended2 = do
    ...
    (uobj8, o8) <- either (assertFailure . show) pure res8
    assertEqual "leftover" True (o8 == endOffset s7)
    let obj8 :: NonSpare (Cat_000_1_0 ~> "054") = NonSpare uobj8
        var8 = getVariation obj8
    assertUint 1 (fromJust $ getExtendedItem @"I1" var8)
    assertUint 2 (fromJust $ getExtendedItem @"I2" var8)
    assertUint 3 (fromJust $ getExtendedItem @"I3" var8)
    assertUint 4 (fromJust $ getExtendedItem @"I4" var8)
    assertUint 5 (fromJust $ getExtendedItem @"I5" var8)
...
testExplicit2 = do
    ...
    (uobj2, o) <- either (assertFailure . show) pure result
    assertEqual "leftover" True (o == endOffset bs)
    let obj2 :: Expansion (ExpansionOf Ref_000_1_0) = Expansion uobj2
        i1 = fromJust $ getExpansionItem @"I1" obj2
        i2 = fromJust $ getExpansionItem @"I2" obj2
    assertUint 1 i1
    assertUint 2 i2
...
testExplicit3a = do
    ...
    let act = parseRecord (schema @(RecordOf Cat_000_1_0) Proxy)
        ...
        result = parse StrictParsing act bs
    (ur2, o2) <- either (assertFailure . show) pure result
    assertEqual "leftover" True (o2 == endOffset bs)
    let r2 :: Record (RecordOf Cat_000_1_0) = Record ur2
        i072 = fromJust $ getRecordItem @"072" r2
        s :: Bits = unparse $ getExplicitData $ getVariation i072
    ...
    (uobj3, o3) <- either (assertFailure . show) pure result3
    assertEqual "leftover" True (o3 == endOffset bs3)
    let obj3 :: Expansion (ExpansionOf Ref_000_1_1) = Expansion uobj3
        i1 = fromJust $ getExpansionItem @"I1" obj3
        i2 = fromJust $ getExpansionItem @"I2" obj3
        i3 = fromJust $ getExpansionItem @"I3" obj3
    assertUint 1 i1
    assertUint 2 i2
    assertUint 3 i3
...
testExplicit3c = do
    ...
    let obj3 :: Expansion (ExpansionOf Ref_000_1_2) = Expansion uobj3
        i1 = fromJust $ getExpansionItem @"I1" obj3
        i2 = fromJust $ getExpansionItem @"I2" obj3
        i3 = getExpansionItem @"I3" obj3
    assertUint 1 i1
    assertUint 2 i2
    assertEqual "i3" True (isNothing i3)

testCompound3 :: Assertion
testCompound3 = do
    ...
    let obj1 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        obj1 = compound
            ( item @"I1" 1
           *: nil )
    assertEqual "I1" True (isJust $ getCompoundItem @"I1" $ getVariation obj1)
    assertEqual "I2" True (isNothing $ getCompoundItem @"I2" $ getVariation obj1)
    assertEqual "I3" True (isNothing $ getCompoundItem @"I3" $ getVariation obj1)
    ...
    let obj12 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        obj12 = compound
           ...
           *: item @"I2" 2
           *: nil )
    assertEqual "I1" True (isJust $ getCompoundItem @"I1" $ getVariation obj12)
    assertEqual "I2" True (isJust $ getCompoundItem @"I2" $ getVariation obj12)
    assertEqual "I3" True (isNothing $ getCompoundItem @"I3" $ getVariation obj12)
    ...
    let obj13 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        obj13 = compound
           ...
           *: item @"I3" 3
           *: nil )
    assertEqual "I1" True (isJust $ getCompoundItem @"I1" $ getVariation obj13)
    assertEqual "I2" True (isNothing $ getCompoundItem @"I2" $ getVariation obj13)
    assertEqual "I3" True (isJust $ getCompoundItem @"I3" $ getVariation obj13)
    ...
    let obj123 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        obj123 = compound
           ...
           *: item @"I3" 3
           *: nil )
    assertEqual "I1" True (isJust $ getCompoundItem @"I1" $ getVariation obj123)
    assertEqual "I2" True (isJust $ getCompoundItem @"I2" $ getVariation obj123)
    assertEqual "I3" True (isJust $ getCompoundItem @"I3" $ getVariation obj123)
...
testCompoundSet = do
    let obj1, obj2 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        ...
        var2 = setCompoundItem @"I2" 2 var1
...
testCompoundDel = do
    let obj123, obj13 :: NonSpare (RecordOf Cat_000_1_0 ~> "093")
        ...
        var = delCompoundItem @"I2" (getVariation obj123)
...
testRecord = do
    ...
    assertUnparse "00" r0
    assertEqual "item 000" True (isNothing $ getRecordItem @"000" r0)

    let r1 :: Record (RecordOf Cat_000_1_0) = record
            ( item @"000" 0x03
           *: nil )
    assertUnparse "4003" r1
    let i0 = fromJust $ getRecordItem @"000" r1
    assertUint 0x03 i0
    ...
    let r2a :: Record (RecordOf Cat_000_1_0) = record
           ...
           *: item @"000" 0x03
           *: nil )
    assertEqual "000" True (isJust $ getRecordItem @"000" r2a)
    let r2a010 = fromJust $ getRecordItem @"010" r2a
    assertUint 0x01 (getGroupItem @"SAC" $ getVariation r2a010)
    assertUint 0x02 (getGroupItem @"SIC" $ getVariation r2a010)
    ...
    let withRfs :: Record (RecordOf Cat_000_1_0) = record
           ...
           *: rfs -- or rfs @0, to be explicit which rfs, but there is only one
               ...
               *: item @"000" 0x55
               *: item @"010" 0x1234
               *: item @"053" (extended (1 *: 2 *: fx *: nil))
               *: item @"054" (extended (1 *: 2 *: fx *: nil))
               *: item @"061" (repetitive $ NE.singleton 0xFF)
               *: nil )
           *: nil )
    assertUnparse "410104030602AA02550112340A03040B03040C01FF" withRfs
...
testRecordMultipleRFS = do
    pure ()
{- TODO
 - ... use (rfs @0 ...), (rfs @1 ...), to indicate which 'rfs'
...
testRecordSetItem = do
    let r0, r1 :: Record (RecordOf Cat_000_1_0)
        r0 = setRecordItem @"000" 0x03 (record nil)
...
testMultipleUAPS = do
    let recPlot :: Record (Cat_001_1_0 ~~> "plot") = record
            ( item @"010" 1
           *: item @"020" (extended
    ...
    let recTrack :: Record (Cat_001_1_0 ~~> "track") = record
            ( item @"010" 1
           *: item @"020" (extended
...
testCreateDatagram = do
    let db0 :: Datablock (DatablockOf Cat_000_1_0) = datablock
        ...
        db1 :: Datablock (DatablockOf Cat_001_1_0) = datablock
            ( (record ( item @"010" 1 *: nil) :: Record (Cat_001_1_0 ~~> "plot"))
           *: (record ( item @"010" 2 *: nil) :: Record (Cat_001_1_0 ~~> "track"))
           *: nil )
...
testParse2 = do
    ...
    (records, _) <- either (assertFailure . show) pure result
...
testParse3 = do
    let recPlot :: Record (Cat_001_1_0 ~~> "plot")
        recPlot = record
            ( item @"010" 0x0102
           *: item @"020" (extended
                ( item @"TYP" 0 *: 0 *: fx *: nil))
           *: item @"031" 0
           *: nil )
        recTrack :: Record (Cat_001_1_0 ~~> "track")
        recTrack = record
            ( item @"010" 0x0102
           *: item @"020" (extended
                ( item @"TYP" 1 *: 0 *: fx *: nil))
    ...
    do
        ...
        let act1 = parseRecords (schema @(Cat_001_1_0 ~~> "plot") Proxy)
        (result1, _) <- either (assertFailure . show) pure
        ...
        let act2 = parseRecords (schema @(Cat_001_1_0 ~~> "track") Proxy)
        ...
        (result3s, _) <- either (assertFailure . show) pure
    ...
    do
        ...
        -- try to parse as 'tracks'
        let act2 = parseRecords (schema @(Cat_001_1_0 ~~> "track") Proxy)
        (result2, _) <- either (assertFailure . show) pure
...
testParse4 = do
    ...
    do -- one
        ...
        (results, _) <- either (assertFailure . show) pure
...
testParseNonblocking = do
    ...
    forM_ [minBound..] $ \(mode :: ParsingMode) -> do
        (r1, o) <- either (assertFailure . show) pure
            (parse mode (parseRecord $ schema @(RecordOf Cat_000_1_1) Proxy) s)
        assertEqual "leftover" True (o == endOffset s)
        assertEqual "unparse" (unparse @Bits record1) (unparse r1)

    -- old edition, partial parsing shall not fail
    (r2, o) <- either (assertFailure . show) pure
            (parse PartialParsing (parseRecord $ schema @(RecordOf Cat_000_1_0) Proxy) s)
    assertEqual "unparse" (unparse @Bits record0) (unparse @Bits r2)
    assertEqual "remaining" (integerToBits 0 8 0xff) (Bits s o (coerce $ endOffset s))
